...
const BODY = (
    <div style={{background: "black", height: "100px", width: "10px", position: "absolute", top: "120px", right: "0px"}}></div>
)
...
const RIGHT_LEG = (
    <div style={{background: "black", height: "10px", width: "100px", position: "absolute", top: "210px", right: "-90px", rotate:"60deg", transformOrigin: "left bottom"}}></div>
)
